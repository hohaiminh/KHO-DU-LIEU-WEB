...
<head>
    ...
    <link href="/KHO-DU-LIEU-WEB/Minh/frontend/css/style.css" type="text/css" rel="stylesheet" />
</head>
    ...
    <?php
        ...
        if (isset($_POST['btnGoiLoiNhan'])) {
            ...
            try {
                ...
                $mail->Username = 'hhminhd20021@cusc.ctu.edu.vn'; // SMTP username
                $mail->Password = 'keklssuaswovlwpm';                   // SMTP password
                ...
                //Recipients
                $mail->setFrom('minhb1706497@student.ctu.edu.vn', 'Mail Liên hệ');
                $mail->addAddress('hohaiminhh@gmail.com');               // Add a recipient
