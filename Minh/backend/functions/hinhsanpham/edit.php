        ...
        */
        ...
        <form name="frmhinhsanpham" id="frmhinhanpham" method="post" action="" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <br />
            <img src="/KHO-DU-LIEU-WEB/Minh/assets/uploads/products/<?= $hinhsanphamRow['hsp_tentaptin'] ?>" class="img-fluid" width="300px" />
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="preview-img-container">
              <img src="../../../assets/macdinh/1641036.jpg" id="preview-img" width="200px" />
            </div>
