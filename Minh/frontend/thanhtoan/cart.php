            ...
            <div class="row">
                <div class="col col-md-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (empty($sanpham['hinhdaidien'])) : ?>
                                                <img src="/KHO-DU-LIEU-WEB/Minh/assets/shared/img/default-image_600.png" class="img-fluid hinhdaidien" />
                                            <?php else : ?>
                                                <img src="/KHO-DU-LIEU-WEB/Minh/assets/uploads/products/<?= $sanpham['hinhdaidien'] ?>" class="img-fluid hinhdaidien" />
                                            <?php endif; ?>
                                        </td>
                    ...
                    <?php else : ?>
                        <h2>Giỏ hàng rỗng!!!</h2>
                    <?php endif; ?>
                    <a href="/KHO-DU-LIEU-WEB/Minh/frontend" class="btn btn-warning btn-md"><i class="fa fa-arrow-left" aria-hidden="true"></i> Quay
                        về trang chủ</a>
                    <a href="/KHO-DU-LIEU-WEB/Minh/frontend/thanhtoan/thanhtoan.php" class="btn btn-primary btn-md"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Thanh toán</a>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            function removeSanPhamVaoGioHang(id) {
                ...
                $.ajax({
                    url: '/KHO-DU-LIEU-WEB/Minh/api/giohang-xoasanpham.php',
                    method: "POST",
                    dataType: 'json',
                    data: dulieugoi,
            ...
            function capnhatSanPhamTrongGioHang(id, soluong) {
                ...
                $.ajax({
                    url: '/KHO-DU-LIEU-WEB/Minh/frontend/api/giohang-capnhatsanpham.php',
                    method: "POST",
                    dataType: 'json',
                    data: dulieugoi,
                    success: function(data) {
